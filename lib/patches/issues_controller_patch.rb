...
unless IssuesController.included_modules.include?(KohaSuomiIssueVotes::Patches::IssuesControllerPatch)
  IssuesController.send(:include, KohaSuomiIssueVotes::Patches::IssuesControllerPatch)
end
